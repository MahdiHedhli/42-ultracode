...
_POLICY_BOUNDARIES: Mapping[ReviewedPromptPolicy, Mapping[str, str]] = MappingProxyType(
    {
        ...
        ReviewedPromptPolicy.F017_M2_D6_CHECKPOINT_FREE_SYNTHETIC_REPACK_ROUND_TRIP: MappingProxyType(
            {
...
_REVIEWED_POLICIES: Mapping[ReviewedPromptPolicy, _PromptAuthorizationPolicy] = MappingProxyType(
    {
        ...
        ReviewedPromptPolicy.F017_M2_D6_CHECKPOINT_FREE_SYNTHETIC_REPACK_ROUND_TRIP: _mint_reviewed_policy(
            ReviewedPromptPolicy.F017_M2_D6_CHECKPOINT_FREE_SYNTHETIC_REPACK_ROUND_TRIP,
            schema=PROMPT_SCHEMA,
            feature_id="F017",
            machine_model="MacBook Pro M2 Max",
            machine_architecture="arm64",
